namespace MoneyKeeper.Application.Common
{
    public static class ErrorCodes
    {
        ...
        public const string CATEGORY_HAS_OPERATIONS = "CATEGORY_HAS_OPERATIONS";
        ...
        public const string INVALID_TRANSITION_SUM = "INVALID_TRANSITION_SUM";

        public const string TRANSITION_DESCRIPTION_IS_EMPTY = "TRANSITION_DESCRIPTION_IS_EMPTY";

        public const string TRANSITION_DESCRIPTION_IS_TOO_LONG = "TRANSITION_DESCRIPTION_IS_TOO_LONG";

        public const string TRANSITION_NOT_FOUND = "TRANSITION_NOT_FOUND";

        public const string SAME_TRANSITION_ACCOUNTS = "SAME_TRANSITION_ACCOUNTS";

        public const string UNKNOWN_TRANSITION_DELETING_ERROR = "UNKNOWN_TRANSITION_DELETING_ERROR";

        public const string UNKNOWN_TRANSITION_UPDATING_ERROR = "UNKNOWN_TRANSITION_UPDATING_ERROR";

        public const string TRANSITION_CANCELING_DENIED = "TRANSITION_CANCELING_DENIED";

        public const string TRANSITION_UPDATING_DENIED = "TRANSITION_UPDATING_DENIED";
    }
}
